...
from methods.utils import ImageLogCallback, state_dict_ckpt
...
parser.add_argument('--text_enc', default='bert', help='bert, clip_text')
...
def main(args):
    ...
    method = Method(model=model, datamodule=datamodule, args=args)
